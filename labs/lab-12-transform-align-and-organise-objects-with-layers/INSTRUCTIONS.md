...
| **Final filename** | `Lab-12-Completed.indd` |
...
1. Read this guide completely, then duplicate `HP_InteractiveDoc.indd` as `Lab-12-Working.indd`.
...
- [ ] Final native file saved as `Lab-12-Completed.indd`
...
1. If the working file is damaged, close it without saving and duplicate `HP_InteractiveDoc.indd` again.
...
![Lab 12](Reference.png)

## Reference Basis

ACP guide domain 3: layers, stacking, visibility, locking and production variants.
