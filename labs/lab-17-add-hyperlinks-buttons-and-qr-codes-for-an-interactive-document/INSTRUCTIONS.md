...
| **Final filename** | `Lab-17-Completed.indd` |
...
1. Read this guide completely, then duplicate `HP_InteractiveDoc_A.indd` as `Lab-17-Working.indd`.
...
- [ ] Final native file saved as `Lab-17-Completed.indd`
...
1. If the working file is damaged, close it without saving and duplicate `HP_InteractiveDoc_A.indd` again.
...
![Lab 17](Reference.png)

## Reference Basis

ACP guide domains 4 and 5: interactive elements, accessible link text and output-dependent behaviour.

Current Adobe Help: https://helpx.adobe.com/indesign/desktop/interactive-elements-and-forms/hyperlinks/create-hyperlinks.html
