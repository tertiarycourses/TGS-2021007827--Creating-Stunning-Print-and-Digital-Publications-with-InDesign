...
| **Final filename** | `Lab-04-Completed.indd` |

## What You Will Do

Diagnose why an unaligned page reads as untidy, then build the invisible skeleton that fixes it: a baseline grid for the type, a document grid for objects, ruler guides for specific positions, and a full modular grid created in one dialog with Layout > Create Guides.

## Phase 1 - Prepare and Baseline

1. Read this guide completely, then duplicate `HP_Brochure_1.indd` as `Lab-04-Working.indd`.
...
- [ ] Final native file saved as `Lab-04-Completed.indd`
...
ACP guide domains 2 and 3: rulers, guides, grids, margins, columns and precise object alignment.
